...
public:
    ...
    MLIR_OpHandle create_scope_container(const char *region_name,
        const std::vector<MLIR_OpHandle> &ops);
    void attach_variable_type_attrs(MLIR_OpHandle var_op, const ASR::ttype_t &t);
    void attach_scope_regions(MLIR_OpHandle scope_op);
