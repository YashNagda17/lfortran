...
extern "C" bool mlir_lower_vector_print_native(MLIR_Context *ctx,
...
extern "C" bool MLIR_LowerToLLVMDialectUpstream(MLIR_Context *ctx,
    ...
    if (has_vector_print) {
        if (!mlir_lower_vector_print_native(ctx, module_h)) {
            std::fprintf(stderr,
                         "MLIR_LowerToLLVMDialectUpstream: vector.print "
                         "lowering failed\n");
            return false;
        }
    }
...
extern "C" bool MLIR_LowerToLLVMDialectForWasmUpstream(MLIR_Context *ctx,
    ...
    if (has_vector_print) {
        if (!mlir_lower_vector_print_native(ctx, module_h)) {
            std::fprintf(stderr,
                         "MLIR_LowerToLLVMDialectForWasmUpstream: vector.print "
                         "lowering failed\n");
            return false;
        }
    }
